...
### ✅ 해결됨: Leptos 0.6 + Axum 0.7 라우터 통합

**해결 완료!** 모든 컴파일 에러가 수정되었습니다.

**해결 방법:**
```rust
// generate_route_list_with_ssg 사용
...
let app = Router::new()
    ...
    .with_state(leptos_options);  // 이 부분이 핵심!

// 이제 into_make_service()가 작동
...
5. ✅ Router state 타입 불일치 - `generate_route_list_with_ssg` + `with_state()` 사용
